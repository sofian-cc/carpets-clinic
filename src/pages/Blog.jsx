...
const POSTS = [
  {
    slug: 'rug-resizing-cotswold-home',
    title: 'Project: Rug Resizing for a Cotswold Country Home',
    excerpt: 'The perfect rug was sourced, but at 350 x 250cm it was too large for the room. Here is how we cut it down, rebound it and installed it on site.',
  ...
  },
  {
    ...
    title: 'Project: Joining Two Rugs for a Large Open-Plan Living Space',
    excerpt: 'The design was right but the available size was too small. Two identical rugs were professionally joined to create a seamless single piece for the space.',
    category: 'Alteration & Fabrication',
    date: 'April 2026',
    isoDate: '2026-04-20',
    read: '4 min read',
    relatedService: { label: 'Alteration & Fabrication', service: 'alteration' },
    content: [
      { type: 'img', src: 'assets/gallery/rug-joining-1.webp', alt: 'Two identical rugs laid out before joining', caption: 'The two identical rugs before joining — same batch, consistent dye lot' },
      { type: 'p', text: 'Large open-plan spaces are one of the most common challenges in residential interior design. The room requires a rug of 4m x 3m or larger. Almost nothing at that scale is available off the shelf, and bespoke commission timelines are often impractical. Joining two rugs is a solution that most designers do not know is available.' },
      { type: 'h2', text: 'The brief' },
      { type: 'p', text: 'The client had found a rug design that suited the space perfectly in terms of pattern, pile and colour. The problem was availability: it only came in one size, and that size was not large enough for the room. Two identical pieces were sourced, and the brief was to join them into a single seamless rug.' },
      ...
      { type: 'img', src: 'assets/gallery/rug-joining-2.webp', alt: 'Rug join in progress — seam alignment and stitching', caption: 'The seam being aligned and stitched by hand' },
      ...
      { type: 'img', src: 'assets/gallery/rug-joining-3.webp', alt: 'Completed joined rug installed in living space', caption: 'The finished joined rug installed in the living space' },
      { type: 'h2', text: 'What interior designers should know' },
      { type: 'ul', items: [
  ...
  },
  {
    ...
    relatedService: { label: 'Alteration & Fabrication', service: 'alteration' },
    content: [
      { type: 'img', src: 'assets/gallery/table-cutout-design.jpg', alt: 'Design drawing for table base cut-out on a rug', caption: 'Planning stage: dimensions and cut-out design confirmed before any cutting begins' },
      ...
      { type: 'h2', text: 'The types of cut-outs we handle' },
      { type: 'ul', items: [
        'Floor vent cut-outs: exposing airflow while keeping the rug intact around all four sides of the vent',
        'Electric box cut-outs: precise openings around in-floor electrical housings with a clean bound edge',
        'Electric box flap: a hinged section cut into the rug allowing access to the box while the rug remains in place',
        'Pillar and column cut-outs: fitting a rug around a structural column with tight tolerances on all sides',
        'Fixed table base cut-outs: cutting around table pedestals and bases where the table cannot be moved',
      ]},
      { type: 'h2', text: 'The process' },
      { type: 'p', text: 'Every cut-out project starts with a site visit or a detailed set of measurements and reference photographs. We create a mock-up to confirm dimensions before any cutting takes place. For complex shapes such as pillar bases or multi-sided table feet, we use a card template made on site.' },
      { type: 'p', text: 'Once dimensions are confirmed, the rug is cut and all exposed edges are bound, matching the original finish as closely as possible. The binding prevents fraying and gives the cut-out a finished, deliberate appearance rather than looking like a workaround.' },
      { type: 'img', src: 'assets/gallery/table-cutout-dimensions.png', alt: 'Technical dimensions drawing for rug cut-out around table base', caption: 'Precise measurements taken on site before the rug is cut' },
      { type: 'h2', text: 'On-site vs studio work' },
      { type: 'p', text: 'Straightforward cut-outs can be completed in our studio once we have an accurate template. For complex installations, particularly where the rug is already laid and the feature is tight to furniture or a wall, we work on site. Our team brings all tools and materials needed to complete the job in a single visit.' },
      { type: 'img', src: 'assets/gallery/table-cutout-after.jpg', alt: 'Rug with completed table base cut-out installed in office', caption: 'The finished cut-out: clean bound edges, rug sitting flush around the fixed table base' },
      { type: 'h2', text: 'What interior designers should know' },
      { type: 'ul', items: [
